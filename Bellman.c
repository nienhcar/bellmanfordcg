...
void title()
{
    ...
    setFont(GLUT_BITMAP_HELVETICA_18);
     glColor3f(1.0,1.0,1.0);
    drawstring(65,460,"Computer Graphics and Visualisation Mini project");
    glColor3f(1.0,1.0,1.0);
    drawstring(100,440,"Topic: Bellman Ford Algorithm");
    glColor3f(1.0,1.0,1.0);
    drawstring(45,400,"Submitted by");
    glColor3f(1.0,0.0,0.0);
    drawstring(100,360,"Rachana V Shanbhogue & Sahithya L Poojary");
    glColor3f(1.0,0.0,0.0);
    drawstring(100,320,"4SF19CS123 and 4SF19CS133");
    glColor3f(1.0,0.0,0.0);
    drawstring(100,250,"Under the Guidance of Mrs Vidya V V");
    glColor3f(1.0,0.0,0.0);
    drawstring(100,230,"Assistant professor,Dept. of CS&E");
     glColor3f(1.0,0.0,0.0);
    drawstring(70,200,"Sahyadri College of Engineering and Management");
    glColor3f(1.0,1.0,1.0);
